...
--
-- Hôte : localhost:8889
-- Généré le :  ven. 28 juin 2019 à 14:12
...
(1, 'WebAgency', '<p style=\"color: #626262;\">Refonte du site de l\'agence WebAgency.</p>\r\n<p style=\"color: #626262;\">Voici les diff&eacute;rentes sections donn&eacute;es par le graphiste:</p>\r\n<div>&nbsp;</div>\r\n<div><img src=\"http://localhost:3000/FinalProjectphp/uploads/maquette_header.png\" alt=\"\" width=\"500\" height=\"254\" /></div>\r\n<div>&nbsp;</div>\r\n<div>&nbsp;</div>\r\n<div><img src=\"http://localhost:3000/FinalProjectphp/uploads/maquette_services.png\" alt=\"\" width=\"500\" height=\"210\" /></div>\r\n<div>&nbsp;</div>\r\n<div><img src=\"http://localhost:3000/FinalProjectphp/uploads/maquette_projets.png\" alt=\"\" width=\"500\" height=\"214\" /></div>\r\n<div>&nbsp;</div>\r\n<div><img src=\"http://localhost:3000/FinalProjectphp/uploads/maquette_carte.png\" alt=\"\" width=\"500\" height=\"218\" /></div>\r\n<div>&nbsp;</div>\r\n<div>&nbsp;</div>', 'projet1-sm.jpg', 'projet1-lg.jpg', 'https://juliaassad.fr/projet1/', 'html,css,jquery,flexbox,Sass', '<p><strong>Excellent projet!</strong></p>\r\n<ul>\r\n<li>D\'un point de vue oral, la pr&eacute;sentation est tr&egrave;s fluide, Julia ma&icirc;trise bien son sujet.</li>\r\n<li>D\'un point de vue technique l\'int&eacute;gralit&eacute; des fonctionnalit&eacute;s attendues sont bien respect&eacute;s . Le code est propre et bien structur&eacute;.</li>\r\n</ul>', 'webagency'),
...
--
-- Index pour la table `projet_categories`
--
...
--
-- AUTO_INCREMENT pour la table `projet_categories`
--
ALTER TABLE `projet_categories`
...
--
-- Contraintes pour la table `projet_categories`
--
ALTER TABLE `projet_categories`
  ADD CONSTRAINT `projet_categories_ibfk_1` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `projet_categories_ibfk_2` FOREIGN KEY (`category_id`) REFERENCES `categories` (`category_id`) ON DELETE CASCADE;
