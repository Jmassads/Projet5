...
--
-- Hôte : localhost:8889
-- Généré le :  lun. 01 juil. 2019 à 16:17
...
(1, 'htmlreference.io', '<p>Htmlreference.io est un site outil qui va vous permettre de bien comprendre l&rsquo;HTML et les diff&eacute;rents attributs.</p>\r\n<p>Ce site r&eacute;f&eacute;rence toutes les balises du langage HTML par ordre alphab&eacute;tique. Un moteur de recherche permet aussi de trouver rapidement une balise.</p>\r\n<p>Pour chacune d&rsquo;entre elles, on dispose d&rsquo;explications d&eacute;taill&eacute;es sur son fonctionnement, des exemples pratiques d&rsquo;utilisation, la description des &eacute;ventuels attributs des balises&hellip;</p>\r\n<div>&nbsp;</div>\r\n<div>&nbsp;</div>\r\n<div>&nbsp;</div>', '<p><span style=\"color: #626262;\">Htmlreference.io est un site outil qui va vous permettre de bien comprendre l&rsquo;HTML et les diff&eacute;rents attributs.</span></p>', 'html-reference-icon.png', 'https://htmlreference.io/', 'htmlreference-io', 0),
(2, 'cssreference.io', '<p>cssreference.io est une documentation visuelle de presque toutes les propri&eacute;t&eacute;s CSS illustr&eacute;es par des exemples visuels et interactifs.</p>', '<p><span style=\"color: #626262;\">cssreference.io est une documentation visuelle de presque toutes les propri&eacute;t&eacute;s CSS illustr&eacute;es par des exemples visuels et interactifs.</span></p>', 'css-reference-icon.png', 'https://cssreference.io/', 'cssreference-io', 0),
